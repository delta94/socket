...
function loadModelFolder(folder) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    dir = path_1["default"].resolve(__dirname, folder);
                    if (!fs_1["default"].existsSync(dir)) return [3 /*break*/, 5];
                    models = helper_1.getFiles(dir);
                    _a = [];
                    for (_b in models)
                        _a.push(_b);
                    _i = 0;
                ...
                case 1:
                    ...
                    i = _a[_i];
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require(models[i])); })];
                case 2:
                    _c.sent();
                    _c.label = 3;
                case 3:
...
function loadRouterFolder(folder) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    if (!fs_1["default"].existsSync(folder)) return [3 /*break*/, 5];
                    models = helper_1.getFiles(folder);
                    _a = [];
                    for (_b in models)
                        _a.push(_b);
                    _i = 0;
                ...
                case 2:
                    ...
                    if (typeof fun["default"] === 'function') {
                        Hook_js_1["default"].add_action('before-router', fun["default"]);
                    }
                    _c.label = 3;
                case 3:
                    _i++;
