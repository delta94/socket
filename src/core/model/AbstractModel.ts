...
export default interface AbstractModel {
    ...
    find(table: string, limit: number, page: number): Promise<{ error?: any, data?: any }>
    ...
    insertOne(): Promise<{ error?: any, insertCount?: number }>

    insertMany(): Promise<{ error?: any, inertCount?: number }>


    update(): Promise<{ error?: any, updateCount?: number }>

    updateOne(): Promise<{ error?: any, updateCount?: number }>

    updateMany(): Promise<{ error?: any, updateCount?: number }>
