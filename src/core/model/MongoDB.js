...
var model_js_1 = require("../helper/model.js");
var util_1 = __importDefault(require("util"));
var Hook_js_1 = __importDefault(require("../Hook.js"));
var helper_js_1 = require("../helper/helper.js");
var database_json_1 = __importDefault(require("../../config/database.json"));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        if (_this.times === 1) {
                            MongoClient.connect(database_json_1["default"].MongoDB.stringConnect, { useUnifiedTopology: true }, function (err, db) {
                                if (err)
                                    throw err;
                                console.log('database created!');
                                _database = db.db(database_json_1["default"].MongoDB.DATABASE);
...
var MongoDB = /** @class */ (function () {
    function MongoDB(name, fields) {
        ...
        this._fields = model_js_1.prepareField(__assign(__assign({}, fields), this.defaultColumn));
        Hook_js_1["default"].do_action('init-model', [this]);
        if (name === 'demo') {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), res1 = _a[0], countDocument = _a[1];
                        paginate = model_js_1.renderPaginate({ page: page, limit: limit, countDocument: countDocument });
    ...
    MongoDB.prototype.findOne = function (find) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Hook_js_1["default"].do_action('findOne-before', __spreadArrays([find], ref))];
                    case 1:
                        cache = (_a.sent()).cache;
                        if (cache)
                        ...
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                _this.collection.findOne(find, function (error, data) {
                                    if (error)
                                        ...
                                        Hook_js_1["default"].do_action('findOne-after', [data]);
                                        resolve({ data: data });
                                    }
                                });
                            })];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0: return [4 /*yield*/, model_js_1._prepareDataField(data, this._fields)];
                                case 1:
                                    _a = _b.sent(), res = _a[0], error = _a[1];
                                        ...
                                        this.collection.insertOne(res, function (error, res) {
                                            ...
                                            if (error) {
                                                if (typeof error.keyValue === 'object') {
                                                    var _b = helper_js_1.objectIndex(error.keyValue, 0), key = _b[0], value = _b[1];
                                                    resolve({
                                                        error: (_a = {},
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, model_js_1._prepareDataField(data, this._fields, update)];
                                case 1:
                                    _a = _b.sent(), res = _a[0], error = _a[1];
                                    // console.log(res, error)
                                    //     return;
                        ...
                        _this.collection.findOneAndUpdate(find, [{ $set: data }], { "new": false, returnOriginal: false }, function (err, res) {
                            ...
                            if (err) {
                                if (typeof err.keyValue === 'object') {
                                    var _b = helper_js_1.objectIndex(err.keyValue, 0), key = _b[0], value = _b[1];
                                    resolve({
                                        error: (_a = {},
                                            _a[key] = _this._fields[key].validate.unique || "This field \"" + key + "\" has exists, please use another value!",
                                            _a)
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    find = this._generateFind(find);
                                    return [4 /*yield*/, model_js_1._prepareDataField(data, this._fields, true)];
                                case 1:
                                    _a = _b.sent(), res = _a[0], error = _a[1];
                                    if (error) {
                                        resolve({ error: error });
                                        ...
                                        this.collection.findOneAndUpdate(find, { $set: res }, { returnOriginal: false }, function (error, res) {
                                            ...
                                            if (error) {
                                                ...
                                                Hook_js_1["default"].do_action('updateOne-after', [res.value]);
                                                resolve({ data: res.value });
                                            }
                                        });
                                    }
