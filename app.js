...
var Authentication_1 = __importStar(require("./src/core/Authentication"));
var Hook_js_1 = __importDefault(require("./src/core/Hook.js"));
var autoload_1 = require("./src/core/autoload");
// var log = console.log;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    app.get('/posts', Authentication_1.authenticateToken, function (req, res) {
                    ...
                    //     })
                    // }
                    return [4 /*yield*/, Hook_js_1["default"].do_action('before-router', [app, server])];
                case 4:
                    // function authenticateToken(req, res, next) {
                    //     const authHeader = req.headers['authorization']
                    //     const token = authHeader && authHeader.split(' ')[1]
